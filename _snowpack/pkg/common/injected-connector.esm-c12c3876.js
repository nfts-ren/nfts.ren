import { A as AbstractConnector } from './abstract-connector.esm-770296ad.js';
  ...
  _proto.activate = function activate() {
    try {
      ...
      var _temp6 = _catch(function () {
        ...
        "production" !== "production" ? warning(false, 'eth_requestAccounts was unsuccessful, falling back to enable') : void 0;
      });
  ...
  _proto.getChainId = function getChainId() {
    try {
        ...
        function _temp9() {
          if (!chainId) {
            try {
              ...
              "production" !== "production" ? warning(false, 'net_version v2 was unsuccessful, falling back to manual matches and static properties') : void 0;
            }
          }
        ...
        var _temp8 = function () {
          if (!chainId) {
            var _temp14 = _catch(function () {
              ...
              "production" !== "production" ? warning(false, 'net_version was unsuccessful, falling back to net version v2') : void 0;
            });
      ...
      var _temp13 = _catch(function () {
        ...
        "production" !== "production" ? warning(false, 'eth_chainId was unsuccessful, falling back to net_version') : void 0;
      });
  ...
  _proto.getAccount = function getAccount() {
    try {
        ...
        var _temp16 = function () {
          if (!account) {
            var _temp22 = _catch(function () {
              ...
              "production" !== "production" ? warning(false, 'enable was unsuccessful, falling back to eth_accounts v2') : void 0;
            });
      ...
      var _temp21 = _catch(function () {
        ...
        "production" !== "production" ? warning(false, 'eth_accounts was unsuccessful, falling back to enable') : void 0;
      });
...
var injectedConnector_esm = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
export { InjectedConnector as I, injectedConnector_esm as i, warning as w };
