import { A as AbstractConnector } from '../common/abstract-connector.esm-770296ad.js';
    ...
    try {
      ...
      var _temp6 = function () {
        if (!_this4.walletConnectProvider) {
          return Promise.resolve(import('../common/index-6549108d.js').then(function (n) { return n.i; }).then(function (m) {
            var _m$default;
