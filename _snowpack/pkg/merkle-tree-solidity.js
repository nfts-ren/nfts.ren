...
var merkleTreeSolidity = createCommonjsModule(function (module, exports) {
...
function combinedHash(first, second, preserveOrder) {
  ...
  if (preserveOrder) {
    return (0, dist.sha3)(bufJoin(first, second));
  } else {
    return (0, dist.sha3)(bufSortJoin(first, second));
  }
}
...
var __pika_web_default_export_for_treeshaking__ = /*@__PURE__*/getDefaultExportFromCjs(merkleTreeSolidity);
